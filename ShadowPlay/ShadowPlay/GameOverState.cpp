...
GameOverState::GameOverState(StateManager& state_manager) :
AbstractState(state_manager)
{
	...
	end_level_ = BASS_SampleLoad(FALSE, "bottle_x.wav", 0, 0, 1, NULL);
	...
	if (!GO_background.loadFromFile("GO_background.png"))
	{
...
void GameOverState::handle_state_changes()
{
...
void GameOverState::handle_input(const sf::Time& delta)
{
