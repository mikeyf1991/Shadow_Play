...
SpriteSheet::SpriteSheet(sf::Time frameTime, bool paused, bool looped) :
m_animation(NULL), m_frameTime(frameTime), m_currentFrame(0), m_isPaused(paused), m_isLooped(looped), m_texture(NULL)
{

}

void SpriteSheet::setAnimation(const Animate& animation)
{
...
void SpriteSheet::setFrameTime(sf::Time time)
{
	m_frameTime = time;
}
...
void SpriteSheet::play(const Animate& animation)
{
...
const Animate* SpriteSheet::getAnimation() const
{
	return m_animation;
}
...
sf::Time SpriteSheet::getFrameTime() const
{
	return m_frameTime;
}

void SpriteSheet::setFrame(std::size_t newFrame, bool resetTime)
{
	if (m_animation)
	{
