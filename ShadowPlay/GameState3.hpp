...
class GameOverState;
//------------------------------ GameState 3 --------------------------------------------
class GameState3 : public AbstractState
{
public:
	GameState3(StateManager& state_manager, bool LoadFromFile); // constructor
	~GameState3();//destructor
...
private:
	...
	Switch switch1_;
	Switch switch2_;
	Wall destroyable_wall1_;
	Wall destroyable_wall2_;
	Wall undestroyable_wall1_;
	Wall undestroyable_wall2_;
	Wall undestroyable_wall3_;
	LevelExit exit_;
	//---------------------------------------------------
	bool game_over_;
	bool next_Level;
